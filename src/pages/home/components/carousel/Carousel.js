            ...
            <div className="w-100 carouselParent">
                <Carousel>
                    <Carousel.Item interval={5000}>
                        <div className="caroudelDiv d-flex w-100 align-items-center flex-lg-row-reverse flex-column justify-content-evenly">
                            <img className="d-block mb-5" src={Image5} alt="First slide" />
                            <div className="carousel-product-info ms-2 d-flex flex-column align-items-lg-start align-items-center justify-content-around">
